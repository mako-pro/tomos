	...
	public function up(): void
	{
		...
		(
			"CREATE TABLE `tomos_settings` (
				...
				`show_followers` enum('1','0') DEFAULT '1' COMMENT 'Show the followers',
				`show_email` enum('1','0') DEFAULT '0' COMMENT 'Show email address',
				`show_phone` enum('1','0') DEFAULT '0' COMMENT 'Show phone',
				`show_experiences` enum('1','0') DEFAULT '1' COMMENT 'Show experiences',
				`show_educations` enum('1','0') DEFAULT '1' COMMENT 'Show educations',
				`show_age` enum('1','0') DEFAULT '1' COMMENT 'Show user age',
				`allow_follow` enum('1','0') DEFAULT '1' COMMENT 'Allow to follow the user',
